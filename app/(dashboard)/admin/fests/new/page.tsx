...
export default function CreateFestPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success) {
        showToast('success', 'Fest created successfully');
        ...
        const firstErr = data.data?.errors
          ...
          : data.error;
        showToast('error', firstErr || 'Failed to create fest');
      }
    } catch {
      showToast('error', 'Failed to create fest');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="page">
        <div className="page-header" style={{ alignItems: 'flex-start' }}>
          <div>
            ...
            <h1>Create a new fest</h1>
            <p className="subtitle">Fill in the details to register a new campus fest.</p>
          </div>
